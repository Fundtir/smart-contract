...
contract FundtirPreSale is Ownable2Step, Pausable, ReentrancyGuard {
    ...
    function previewFundtirForUSDT(
        ...
        uint256 fundtirAmount = usdtAmount * 10 ** (fundtirDecimals + TOKEN_PRICE_DECIMALS) / (tokenPrice * 10 ** usdtDecimals);
    ...
    function buyTokens(uint256 usdtAmount) external whenNotPaused nonReentrant {
        ...
        require(fundtir.balanceOf(address(this)) >= fundtirAmount, "Insufficient Fundtir bal");
